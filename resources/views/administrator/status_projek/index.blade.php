...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Status Projek</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-auto">
            <a href="{{ route('status_projek.create') }}" class="btn btn-success">
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('status_projek.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
...
@section('js')
    <script>
        $('table').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: baseUrl('/status_projek/fetch'),
                headers: {
            ...
            createdRow: function(row, data) {
                $(".action-edit", row).click(function(e) {
                    const url = baseUrl('/status_projek/' + data.id + '/edit');
