...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Type Projek</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-3">
        <div class="col-auto">
            <a href="{{ route('type_projek.create') }}" class="btn btn-success">
    ...
    <div class="d-none">
        <form id="form-destroy" action="{{ route('type_projek.store') }}" method="post">
            @csrf
            @method('DELETE')
        </form>
    </div>
        ...
        $('table').DataTable({
            ...
            createdRow: function(row, data) {
                $(".action-edit", row).click(function(e) {
                    const url = baseUrl('/type_projek/' + data.id + '/edit');
