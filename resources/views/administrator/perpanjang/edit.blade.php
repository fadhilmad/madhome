...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Edit Perpanjang</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary">
        <div class="card-body">
            <h4 class="card-title text-primary mb-4">Edit Perpanjang</h4>
            <form action="{{ route('perpanjang.update', $perpanjang->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <select class="form-select" name="projek_id" id="projek_id">
                                ...
                                @foreach ($projek as $val)
                                    <option value="{{ $val->id }}"
                                        {{ old('projek_id') == $val->id ? 'selected' : ($perpanjang->projek_id == $val->id ? 'selected' : '') }}>
                                        {{ $val->nama }}</option>
                                @endforeach
                            </select>
                            @error('projek_id')
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="harga" id="harga"
                                value="{{ old('harga') ? old('harga') : $perpanjang->harga }}">
                            @error('harga')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="tanggal_start" id="tanggal_start"
                                value="{{ old('tanggal_start') ? old('tanggal_start') : $perpanjang->tanggal_start }}">
                            @error('tanggal_start')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="tangal_ahir" id="tangal_ahir"
                                value="{{ old('tangal_ahir') ? old('tangal_ahir') : $perpanjang->tangal_ahir }}">
                            @error('tangal_ahir')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-xl-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="type_perpanjang" id="type_perpanjang"
                                value="{{ old('type_perpanjang') ? old('type_perpanjang') : $perpanjang->type_perpanjang }}">
                    ...
                    <div class="col-xl-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="deskripsi" id="deskripsi" rows="3">{{ old('deskripsi') ? old('deskripsi') : $perpanjang->deskripsi }}</textarea>
                            @error('deskripsi')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
