...
@section('content')
    <main id="main">
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-5">
                                            <div class="about-img">
                                                <img src="{{ url('/template/DevFolio/assets/img/testimonial-2.jpg') }}"
        ...
        <div class="section-counter paralax-mf bg-image"
            style="background-image: url({{ url('/template/DevFolio/assets/img/counters-bg.jpg') }})">
        ...
        <section id="work" class="portfolio-mf sect-pt4 route">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="{{ url('/template/DevFolio/assets/img/work-1.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox">
                                <div class="work-img">
                                    <img src="{{ url('/template/DevFolio/assets/img/work-1.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </a>
                    ...
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="{{ url('/template/DevFolio/assets/img/work-2.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox">
                                <div class="work-img">
                                    <img src="{{ url('/template/DevFolio/assets/img/work-2.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </a>
                            <div class="work-content">
                    ...
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="{{ url('/template/DevFolio/assets/img/work-3.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox">
                                <div class="work-img">
                                    <img src="{{ url('/template/DevFolio/assets/img/work-3.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </a>
                            <div class="work-content">
                    ...
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="{{ url('/template/DevFolio/assets/img/work-4.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox">
                                <div class="work-img">
                                    <img src="{{ url('/template/DevFolio/assets/img/work-4.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </a>
                            <div class="work-content">
                    ...
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="{{ url('/template/DevFolio/assets/img/work-5.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox">
                                <div class="work-img">
                                    <img src="{{ url('/template/DevFolio/assets/img/work-5.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </a>
                            <div class="work-content">
                    ...
                    <div class="col-md-4">
                        <div class="work-box">
                            <a href="{{ url('/template/DevFolio/assets/img/work-6.jpg') }}"
                                data-gallery="portfolioGallery" class="portfolio-lightbox">
                                <div class="work-img">
                                    <img src="{{ url('/template/DevFolio/assets/img/work-6.jpg') }}" alt=""
                                        class="img-fluid">
                                </div>
                            </a>
                            <div class="work-content">
        ...
        <div class="testimonials paralax-mf bg-image"
            style="background-image: url({{ url('/template/DevFolio/assets/img/overlay-bg.jpg') }})">
            <div class="overlay-mf"></div>
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="testimonials-slider swiper" data-aos="fade-up" data-aos-delay="100">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-box">
                                        <div class="author-test">
                                            <img src="{{ url('/template/DevFolio/assets/img/testimonial-2.jpg') }}"
                                                alt="" class="rounded-circle b-shadow-a">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-box">
                                        <div class="author-test">
                                            <img src="{{ url('/template/DevFolio/assets/img/testimonial-4.jpg') }}"
                                                alt="" class="rounded-circle b-shadow-a">
                ...
                <div class="row">
                        ...
                        <div class="card card-blog">
                            <div class="card-img">
                                <a href="blog-single.html"><img
                                        src="{{ url('/template/DevFolio/assets/img/post-1.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-img">
                                <a href="blog-single.html"><img
                                        src="{{ url('/template/DevFolio/assets/img/post-2.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            </div>
                            <div class="card-body">
                                <div class="card-category-box">
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            <div class="card-img">
                                <a href="blog-single.html"><img
                                        src="{{ url('/template/DevFolio/assets/img/post-3.jpg') }}" alt=""
                                        class="img-fluid"></a>
                            </div>
                            <div class="card-body">
                                <div class="card-category-box">
