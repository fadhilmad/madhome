...
@section('content')
        ...
        <div class="container py-5 px-lg-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">Menjadi pemimpin global dalam menciptakan solusi teknologi yang menginspirasi, memberdayakan, dan memberikan nilai tambah bagi kehidupan masyarakat.</p>

                    <h1 class="mb-4">Misi Kami</h1>
                    <p class="mb-4">Kami berkomitmen untuk menyediakan layanan IT yang sesuai dengan kebutuhan pelanggan, mendorong inovasi guna mempercepat pertumbuhan dan efisiensi bisnis, serta memastikan setiap solusi yang kami kembangkan memiliki kualitas tinggi dan keamanan yang terjamin.</p>
                    ...
                    <a href="#" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill mt-3">Alur Perancangan</a>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" src="{{ asset('/landing/FitApp/img/about.png') }}">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Membantu Anda menciptakan aplikasi mobile berbasis Android dan iOS yang modern dan user-friendly.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Kami merancang website yang interaktif, responsif, dan sesuai dengan identitas brand Anda.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Solusi berbasis IT untuk membantu mengelola operasi bisnis Anda, seperti ERP, CRM, dan sistem khusus lainnya.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Kami menyediakan solusi perangkat lunak yang dirancang khusus untuk kebutuhan unik bisnis Anda.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Dukungan infrastruktur berbasis cloud untuk meningkatkan skalabilitas dan keamanan data Anda.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Memberikan saran strategis untuk membantu Anda memanfaatkan teknologi sebagai alat pertumbuhan bisnis.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container py-5 px-lg-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-4">Antarmuka yang ramah untuk pengguna membuat aplikasi yang sangat mudah digunakan.</h1>
                    <p class="mb-4">Aplikasi ini menawarkan antarmuka yang ramah pengguna, dirancang untuk memberikan pengalaman yang sederhana dan intuitif. Dengan navigasi yang mudah dipahami, pengguna dapat dengan cepat mengakses berbagai fitur tanpa memerlukan panduan tambahan. Kemudahan ini membuat aplikasi menjadi pilihan tepat bagi semua kalangan, baik pemula maupun pengguna berpengalaman, untuk mendukung aktivitas mereka secara efisien dan menyenangkan.</p>
                    <p><i class="fa fa-check text-primary-gradient me-3"></i>Profesionalisme: Tim kami terdiri dari developer dan ahli IT yang berpengalaman.</p>
                    <p><i class="fa fa-check text-primary-gradient me-3"></i>Inovasi Teknologi: Selalu menggunakan teknologi terbaru untuk memberikan solusi terbaik.</p>
                    <p class="mb-4"><i class="fa fa-check text-primary-gradient me-3"></i>Skalabilitas dan Keamanan: Fokus pada solusi yang mudah dikembangkan dan terjamin keamanannya.</p>
                    <p><i class="fa fa-check text-primary-gradient me-3"></i>Pendekatan Kustom: Kami memahami bahwa setiap klien memiliki kebutuhan yang unik.</p>
                    <a href="#" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill mt-3">Price List</a>
                </div>
            ...
            <div class="row gy-5 gx-4 justify-content-center">
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">Perencanaan dan analisis kebutuhan mencakup penentuan tujuan aplikasi, riset pasar, dokumentasi fitur dan spesifikasi, serta penentuan anggaran dan waktu pengembangan.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">Desain aplikasi mencakup pembuatan wireframe untuk alur navigasi, pengembangan desain UI/UX yang menarik, dan pembuatan prototipe untuk uji coba awal.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">Pengembangan aplikasi meliputi pemilihan teknologi, pengembangan frontend dan backend, serta integrasi antara keduanya untuk memastikan aplikasi berfungsi dengan baik.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">Pengujian mencakup QA untuk memastikan fungsi aplikasi, uji kenyamanan pengguna, perbaikan bug, dan stress testing untuk menguji performa di bawah beban tinggi.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">Peluncuran aplikasi meliputi persiapan sesuai standar platform, distribusi di platform yang dipilih, dan strategi pemasaran untuk menjangkau pengguna target.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xxl py-5">
        <div class="container py-5 px-lg-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="{{ asset('/landing/FitApp/img/about.png') }}">
                </div>
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                        <img class="img-fluid bg-white rounded flex-shrink-0 p-1" src="{{ asset('/landing/FitApp/img/testimonial-1.jpg')}}" style="width: 85px; height: 85px;">
                        <div class="ms-4">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-9">
                    <div class="wow fadeInUp" data-wow-delay="0.3s">
                        <p class="text-center mb-4">Siap untuk membawa bisnis Anda ke tingkat yang lebih tinggi? Hubungi kami melalui : <a href="#" class="btn btn-primary-gradient rounded-pill py-1 px-1" target="_blank">Whatsapp</a>.</p>
                        <form>
                            <div class="row g-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-12 text-center">
                                    <button class="btn btn-primary-gradient rounded-pill py-3 px-5" type="submit">Kirim</button>
                                </div>
                            </div>
                        </form>
                    </div>
